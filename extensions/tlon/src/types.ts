...
export function resolveTlonAccount(cfg: DainelConfig, accountId?: string | null): TlonResolvedAccount {
...
export function listTlonAccountIds(cfg: DainelConfig): string[] {
  const base = cfg.channels?.tlon as
