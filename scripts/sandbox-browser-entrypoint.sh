...
export DISPLAY=:1
export HOME=/tmp/dainel-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${DAINEL_BROWSER_CDP_PORT:-9222}"
VNC_PORT="${DAINEL_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${DAINEL_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${DAINEL_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${DAINEL_BROWSER_HEADLESS:-0}"
