...
# Defaults target the Dainel assets so you can just run the script from repo root.
...
DEST_ICNS=${DEST_ICNS:-"$ROOT_DIR/apps/macos/Sources/Dainel/Resources/Dainel.icns"}
