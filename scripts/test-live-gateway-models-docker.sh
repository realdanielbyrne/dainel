...
docker run --rm -t \
  ...
  -e DAINEL_LIVE_GATEWAY_MODELS="${DAINEL_LIVE_GATEWAY_MODELS:-all}" \
  -e DAINEL_LIVE_GATEWAY_PROVIDERS="${DAINEL_LIVE_GATEWAY_PROVIDERS:-}" \
  -e DAINEL_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${DAINEL_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}" \
