...
# Output:
# - dist/Dainel.app
# - dist/Dainel-<version>.zip
# - dist/Dainel-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Dainel-$VERSION.zip"
DMG="$ROOT_DIR/dist/Dainel-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Dainel-$VERSION.notary.zip"
