...
You can also set `DAINEL_VERBOSE=1` instead of the flag.
...
- Check the allowlist: `dainel config get agents.defaults.models`
...
If you can, include the relevant log tail from `dainel logs --follow`.
