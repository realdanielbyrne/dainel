---
summary: "Model providers (LLMs) supported by Dainel"
read_when:
...
Dainel can use many LLM providers. Pick one, authenticate, then set the default
...
1) Authenticate with the provider (usually via `dainel onboard`).
