---
summary: "Use MiniMax M2.1 in Dainel"
read_when:
  - You want MiniMax models in Dainel
...
Configure manually via `dainel.json`:
...
- Use `dainel models list` and `dainel models set minimax/MiniMax-M2.1` to switch.
...
- Running `dainel configure` and selecting **MiniMax M2.1**, or
