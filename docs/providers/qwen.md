---
summary: "Use Qwen OAuth (free tier) in Dainel"
read_when:
  - You want to use Qwen with Dainel
...
```bash
dainel models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, Dainel will sync credentials
