...
Dainel has two separate “streaming” layers:
...
When block streaming is enabled, Dainel can **merge consecutive block chunks**
...
When draft streaming is active, Dainel disables block streaming for that reply to avoid double-streaming.
