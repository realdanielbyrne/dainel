...
This page ties together how Dainel handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Dainel keeps a
...
Dainel separates the **prompt body** from the **command body**:
...
Dainel can expose or hide model reasoning:
