...
Dainel defaults to **host-local time for transport timestamps** and **user timezone only in the system prompt**.
...
When `timeFormat: "auto"`, Dainel inspects the OS preference (macOS/Windows)
