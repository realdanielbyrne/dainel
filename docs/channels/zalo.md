...
- Install via CLI: `dainel plugins install @dainel/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `dainel plugins install ./extensions/zalo`
   - From npm (if published): `dainel plugins install @dainel/zalo`
...
- Approve via:
  - `dainel pairing list zalo`
  - `dainel pairing approve zalo <CODE>`
...
- Example: `dainel message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `dainel channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `dainel logs --follow`
