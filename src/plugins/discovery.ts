...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @dainel/voice-call -> voice-call).
...
function addCandidate(params: {
  ...
  params.candidates.push({
    ...
    packageDainel: getPackageManifestMetadata(manifest ?? undefined),
  });
}
...
export function discoverDainelPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExt = path.join(workspaceRoot, ".dainel", "extensions");
    discoverInDirectory({
      dir: workspaceExt,
      origin: "workspace",
