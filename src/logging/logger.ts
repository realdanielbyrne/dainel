...
export const DEFAULT_LOG_DIR = "/tmp/dainel";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "dainel.log"); // legacy single-file path

const LOG_PREFIX = "dainel";
