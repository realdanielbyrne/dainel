import type { BrowserConfig, BrowserProfileConfig, DainelConfig } from "../config/config.js";
import {
 ...
 *
 * Note: this is a Dainel browser profile (routing config), not a Chrome user profile.
