...
const saveSessionToMemory: HookHandler = async (event) => {
  ...
  try {
    ...
    const cfg = context.cfg as DainelConfig | undefined;
    ...
    if (sessionFile) {
      ...
      if (sessionContent && cfg) {
        ...
        const dainelRoot = path.resolve(path.dirname(fileURLToPath(import.meta.url)), "../..");
        const slugGenPath = path.join(dainelRoot, "llm-slug-generator.js");
