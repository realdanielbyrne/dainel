...
export function applyZaiConfig(cfg: DainelConfig): DainelConfig {
...
export function applyOpenrouterProviderConfig(cfg: DainelConfig): DainelConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: DainelConfig): DainelConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: DainelConfig): DainelConfig {
...
export function applyOpenrouterConfig(cfg: DainelConfig): DainelConfig {
...
export function applyMoonshotProviderConfig(cfg: DainelConfig): DainelConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: DainelConfig): DainelConfig {
...
export function applyKimiCodeProviderConfig(cfg: DainelConfig): DainelConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: DainelConfig): DainelConfig {
...
export function applySyntheticProviderConfig(cfg: DainelConfig): DainelConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: DainelConfig): DainelConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: DainelConfig): DainelConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: DainelConfig): DainelConfig {
