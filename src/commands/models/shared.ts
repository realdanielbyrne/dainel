...
import { type DainelConfig, readConfigFileSnapshot, writeConfigFile } from "../../config/config.js";
...
export async function updateConfig(
  mutator: (cfg: DainelConfig) => DainelConfig,
...
export function resolveModelTarget(params: { raw: string; cfg: DainelConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: DainelConfig): Set<string> {
