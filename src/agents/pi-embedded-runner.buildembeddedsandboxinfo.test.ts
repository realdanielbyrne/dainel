...
const _makeOpenAiConfig = (modelIds: string[]) =>
  ...
  }) satisfies DainelConfig;

const _ensureModels = (cfg: DainelConfig, agentDir: string) =>
  ensureDainelModelsJson(cfg, agentDir) as unknown;
...
describe("buildEmbeddedSandboxInfo", () => {
  ...
  it("maps sandbox context into prompt info", () => {
    const sandbox = {
      ...
      workspaceDir: "/tmp/dainel-sandbox",
      agentWorkspaceDir: "/tmp/dainel-workspace",
      ...
      browser: {
        ...
        containerName: "dainel-sbx-browser-test",
      },
