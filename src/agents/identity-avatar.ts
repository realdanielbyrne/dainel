...
function resolveAvatarSource(cfg: DainelConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: DainelConfig, agentId: string): AgentAvatarResolution {
