  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "dainel.sandbox=1",
        "--label",
        "dainel.sessionKey=main",
        "--label",
        "dainel.createdAtMs=1700000000000",
        "--label",
        "dainel.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
