...
function resolveMainSessionKeyForSandbox(params: { cfg?: DainelConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: DainelConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`dainel sandbox explain --session ${runtime.sessionKey}`)}`,
  );
