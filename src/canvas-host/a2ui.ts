...
export const A2UI_PATH = "/__dainel__/a2ui";
export const CANVAS_HOST_PATH = "/__dainel__/canvas";
export const CANVAS_WS_PATH = "/__dainel/ws";
...
(() => {
  ...
  const handlerNames = ["dainelCanvasA2UIAction", "${legacyHandlerName}"];
  ...
  globalThis.Dainel = globalThis.Dainel ?? {};
  globalThis.Dainel.postMessage = postToNode;
  globalThis.Dainel.sendUserAction = sendUserAction;
  globalThis.dainelPostMessage = postToNode;
  globalThis.dainelSendUserAction = sendUserAction;
  globalThis.dainelPostMessage = postToNode;
  globalThis.dainelSendUserAction = sendUserAction;
