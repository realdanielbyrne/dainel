...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@dainel", { botUsername: "dainel" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@dainel args", {
        botUsername: "dainel",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "dainel" })).toBe(
      "/help@otherbot",
    );
  });
