...
import type { AgentElevatedAllowFromConfig, DainelConfig } from "../../config/config.js";
...
export function formatElevatedUnavailableMessage(params: {
  ...
  if (params.sessionKey) {
    lines.push(`See: ${formatCliCommand(`dainel sandbox explain --session ${params.sessionKey}`)}`);
  }
  return lines.join("\n");
}
