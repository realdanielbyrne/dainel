...
function resolveMentionPatterns(cfg: DainelConfig | undefined, agentId?: string): string[] {
  if (!cfg) return [];
...
export function buildMentionRegexes(cfg: DainelConfig | undefined, agentId?: string): RegExp[] {
