...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof DainelConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: DainelConfig; env: NodeJS.ProcessEnv }): {
  cfg: DainelConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
