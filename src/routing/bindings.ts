...
export function listBindings(cfg: DainelConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: DainelConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: DainelConfig) {
