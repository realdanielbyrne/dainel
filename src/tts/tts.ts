...
export function resolveTtsConfig(cfg: DainelConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.DAINEL_TTS_PREFS?.trim();
...
export function buildTtsSystemPromptHint(cfg: DainelConfig): string | undefined {
