...
function resolveAnthropicDefaultAuthMode(cfg: DainelConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: DainelConfig): DainelConfig {
...
export function applyTalkApiKey(config: DainelConfig): DainelConfig {
...
export function applyModelDefaults(cfg: DainelConfig): DainelConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: DainelConfig): DainelConfig {
...
export function applyLoggingDefaults(cfg: DainelConfig): DainelConfig {
...
export function applyContextPruningDefaults(cfg: DainelConfig): DainelConfig {
...
export function applyCompactionDefaults(cfg: DainelConfig): DainelConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) return cfg;
