...
export type ChannelAgentToolFactory = (params: { cfg?: DainelConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: DainelConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: DainelConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: DainelConfig }) => boolean;
  supportsCards?: (params: { cfg: DainelConfig }) => boolean;
