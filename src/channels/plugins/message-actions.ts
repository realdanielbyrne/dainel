...
export function listChannelMessageActions(cfg: DainelConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: DainelConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: DainelConfig): boolean {
  for (const plugin of listChannelPlugins()) {
