...
import { type DainelConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: DainelConfig): string[] {
...
export function listAgentsForGateway(cfg: DainelConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: DainelConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: DainelConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: DainelConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: DainelConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: DainelConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: DainelConfig): GatewaySessionsDefaults {
