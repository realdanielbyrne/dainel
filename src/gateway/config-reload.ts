...
import type { DainelConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: DainelConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: DainelConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: DainelConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: DainelConfig) => void;
  log: {
