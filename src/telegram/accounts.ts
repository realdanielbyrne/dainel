...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.DAINEL_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: DainelConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: DainelConfig): string {
...
function mergeTelegramAccountConfig(cfg: DainelConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: DainelConfig): ResolvedTelegramAccount[] {
